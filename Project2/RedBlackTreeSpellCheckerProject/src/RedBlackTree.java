public class RedBlackTree {
     ...
     **/
    public RedBlackTree() {
        this.NIL = new RedBlackNode(null, BLACK, null, null, null);
        this.head = new RedBlackNode(null, BLACK, NIL, NIL, NIL);
        this.size = 0;
    }
    ...
    public void insert(String value) {
        ...
        RedBlackNode valueNode = new RedBlackNode(value, RED, current, NIL, NIL);
        if (current == NIL)
            head = valueNode;
        else {
     ...
     *   None
     * @postcondition
     *   displays tree nodes in level order
     *
     * runtime: Θ(N)
     **/
